...
LRESULT CALLBACK WndProc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam) {
	HWND staticTextField1, staticTextField2, button1, editTotal;
			...
			//switch (LOWORD(wParam)){
		        ...
		        //case BN_CLICKED:
		          ...
		          if( LOWORD( wParam ) == ID_BUTTON1 ) {
		              MessageBox(hwnd, "Button 1 foi acionado / WM_COMMAND", "Yay", MB_OK | MB_ICONINFORMATION);
		              return 0;
		          } 
		          //break;				
				...
				//case ID_BUTTON1:
				//button1;
				//TextOut(hdc, 105, 60, "Click Button 1", strlen("Click Button 1"));
				//break;
				//}
